...
export const metadata = {
  title: sitePageTitle('Спортын төрлүүд'),
    ...
    <>
      ...
      <section className="section" style={{ padding: '48px 0' }}>
        <div className="wrap-wide" style={{ display: 'flex', gap: 16, flexWrap: 'wrap' }}>
          <Link href={naadam.schedule} className="btn-primary">Хуваарь үзэх →</Link>
          <Link href={naadam.register} className="btn-ghost">Бүртгүүлэх ▷</Link>
        </div>
      </section>
    </>
  )
