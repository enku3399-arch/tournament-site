...
export const metadata = {
  title: sitePageTitle('Үр дүн'),
  description: sitePageTitle('Үр дүн'),
}
    ...
    <>
        ...
        <section className="section" style={{ paddingTop: 0, paddingBottom: 80, textAlign: 'center' }}>
          <div className="wrap-wide">
            <div style={{
              ...
              <Link href={naadam.schedule} className="btn-ghost" style={{ marginTop: 24, display: 'inline-block' }}>
                Хуваарь харах →
              </Link>
            </div>
          </div>
      ...
      <section className="section" style={{ padding: '32px 0 64px' }}>
        <div className="wrap-wide" style={{ display: 'flex', gap: 16, flexWrap: 'wrap' }}>
          <Link href={naadam.medals} className="btn-primary">Медалийн хүснэгт →</Link>
          <Link href={naadam.live} className="btn-ghost">Шууд дамжуулалт ▷</Link>
          <Link href={naadam.home} className="section-action" style={{ alignSelf: 'center', fontSize: 14 }}>← Наадмын нүүр</Link>
        </div>
      </section>
